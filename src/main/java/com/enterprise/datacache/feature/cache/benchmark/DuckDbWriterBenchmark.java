package com.enterprise.datacache.feature.cache.benchmark;
 ...
 * production.
 *
 * <p>Run via Gradle: {@code ./gradlew runBenchmark --args="--rows=5000000 --batch-size=100000"}
 * or directly: {@code java -cp ... com.enterprise.datacache.feature.cache.benchmark.DuckDbWriterBenchmark --rows=5000000}
 */

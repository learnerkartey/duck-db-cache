 ...
 * cache. This is the primary integration point for another Spring Boot application embedding this
 * {@code feature.cache} package: inject this interface and call {@link #execute} with the query name
